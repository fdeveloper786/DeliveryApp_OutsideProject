...
class _EditAccountState extends State<EditAccount> {
  ...
  void initState() {
    ...
    widget.snapshot.data['address']!=null?l=List.from(widget.snapshot.data['address']):null;
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(appBar: AppBar(elevation: 0,
      ...
      title: Text('Edit Account',style: GoogleFonts.poppins(),),),
      body: SingleChildScrollView(
        child: Column(children: [
              ...
              child: GestureDetector(
                child: ClipRRect(
                  ...
                  child: img!=null?Image.file(img):url!=null&&url.isNotEmpty?CachedNetworkImage(imageUrl: url,
                    fit: BoxFit.cover,):CircleAvatar(radius: 67, backgroundColor: Color(0xff00D3FF),
          ...
          Container(alignment: Alignment.centerLeft,
              ...
              child: Text('Shipping Address',textAlign: TextAlign.left,style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),)
          ),
          Container(width: MediaQuery.of(context).size.width,
            height: 140,
            child: ListView(padding: EdgeInsets.only(left: 12),shrinkWrap: true,scrollDirection: Axis.horizontal,children: List.generate(l!=null&&l.isNotEmpty?l.length+1:1, (index){
              return l!=null&&l.isNotEmpty&&l.length>index?Card(
                child: Container(width: MediaQuery.of(context).size.width*0.7,
                  child: ListTile(title: Text('${l[index]['name']}',style: TextStyle(fontWeight: FontWeight.bold),),
                    subtitle: Padding(
                      padding: const EdgeInsets.only(top: 8),
                      child: Text('${l[index]['address']}',style: TextStyle(fontWeight: FontWeight.bold),),
                    ),
                  ),
                ),
              ):GestureDetector(
                child: Card(child: Container(width: MediaQuery.of(context).size.width*0.7,
                  child: Column(mainAxisAlignment: MainAxisAlignment.center,children: [
                    IconButton(icon: Icon(Icons.local_shipping_outlined),onPressed: (){
            ...
            child: RaisedButton(elevation: 1,
              ...
              child: Ink(
                decoration: BoxDecoration(
                    gradient: LinearGradient(colors: [Color(0xff00D3FF),Color(0xff00D3FF)],
                ...
                return Container(
                  ...
                  child: SingleChildScrollView(
                    child: Column(mainAxisSize: MainAxisSize.min,
                      ...
                      children: <Widget>[
                        ListTile(tileColor: Colors.blue.shade50,
                          title: Text('Add delivery address',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16),),
                        ...
                        Container(height: 60,
                          ...
                          child: TextField(controller: city,
                            ...
                            decoration: InputDecoration(
                              border: OutlineInputBorder(borderSide: BorderSide(color: Colors.grey.shade50,width: 1),borderRadius: BorderRadius.circular(8),),
                              labelText: 'City',
                            ),
                          ),
                        ),
                        Container(height: 60,
                          padding: const EdgeInsets.all(8.0),
                          child: TextField(controller: pincode,
                            readOnly: true,
                            decoration: InputDecoration(
                          ...
                          child: Container(
                            ...
                            child: MaterialButton(
                                ...
                                onPressed: () async{
                                  var v={
                                    'name':editName.text,
                                    'address':'${house.text},${locality.text},${city.text},${pincode.text}'
                                  };
                                  l.add(v);
                                  _state();
                                }
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          child: Text('Choose Profile',style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
                        ),
                        ListTile(
                          leading: Icon(Icons.camera_alt),
                          title: Text("Camera"),
                          onTap: () async{
                            final  image = await ImagePicker.pickImage(source: ImageSource.camera, maxWidth: 512, maxHeight: 512, imageQuality: 70);
                            if(image!=null){
                              setState(() {
                                img=image;
                              });
