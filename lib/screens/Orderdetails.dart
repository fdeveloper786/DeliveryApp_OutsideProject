  ...
  Widget build(BuildContext context) {
    return Scaffold(backgroundColor: Colors.white10.withOpacity(0.95),
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("My Orders",style: GoogleFonts.poppins(color: Color.fromRGBO(0, 211, 225, 1)),
        ),
      ),
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text("21 jan,at 10:30 pm",style: GoogleFonts.poppins(),)
                    ],
                  ),
                ),
                Padding(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Container(decoration: BoxDecoration(color: Color(0xff32CC34).withOpacity(0.1),borderRadius: BorderRadius.circular(8)),
                            ...
                            child: Text('${widget.snapshot.data['status']}',style: GoogleFonts.poppins(fontSize: 14,
                ...
                trailing: ImageIcon(AssetImage("assets/del.png"),size: 40,color: Color.fromRGBO(0, 211, 225, 1)),),
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Text('₹${snapshot.data.documents[index]['total']}',
                                                  style: GoogleFonts.poppins(fontSize: 18,fontWeight: FontWeight.bold,color: Color(0xff00D3FF))),
                                            ],
                                          ),
                                        ),
                                        SizedBox(height: 4,)
